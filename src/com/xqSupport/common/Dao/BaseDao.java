...
//            this.entityClazz = (Class<T>) type.g
    ...
    public org.springframework.orm.hibernate5.HibernateTemplate getMHibernateTemplate() {
    ...
    public String getKeyValue(Map<String, String[]> parameterMap, String keyName, String defaultValue) {
